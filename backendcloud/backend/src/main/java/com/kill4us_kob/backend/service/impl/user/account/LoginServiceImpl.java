...
import com.kill4us_kob.backend.service.user.account.LoginService;
...
public class LoginServiceImpl implements LoginService {
    ...
    public Map<String, String> getToken(String username, String password) {
        ...
        Authentication authenticate = authenticationManager.authenticate(authenticationToken);  //  若登录失败，则自动报异常处理
