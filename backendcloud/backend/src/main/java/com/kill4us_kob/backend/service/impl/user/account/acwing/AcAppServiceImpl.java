...
import com.kill4us_kob.backend.service.user.account.acwing.AcAppService;
...
public class AcAppServiceImpl implements AcAppService {
    ...
    private static final String redirectUri = "https://app6690.acapp.acwing.com.cn/api/user/account/acwing/acapp/receive_code/";
    ...
    public JSONObject applyCode() {
        ...
        //resp.put("result", "success");  //  默认结果是成功的
