            ...
            <div class="col-3">
                <form @submit.prevent="register">
                    ...
                    <div class="mb-3">
                        ...
                        <input v-model="confirmedPassword" type="password" class="form-control" id="confirmedPassword" placeholder="输入你的密码">
                    </div>
...
export default {
    ...
    setup() {
        ...
        const register = () => {
            $.ajax({
                url: "https://app6690.acapp.acwing.com.cn/api/user/account/register/",
                type: "post",
                data: {
